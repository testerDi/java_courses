 ...
 */
public class InsectUseConstructure extends Zoom implements Flyer

    {
        private int num_of_Wings;
        private int num_of_Legs;
        public InsectUseConstructure(int num_of_Legs, int num_of_Wings){
            this.num_of_Legs = num_of_Legs;
            this.num_of_Wings = num_of_Wings;
        }

    public int getNum_of_Wings(){return this.num_of_Wings;}

    public  void setNum_of_Wings(int value){
        this.num_of_Wings = value ;
    }

    public int getNum_of_Legs(){return this.num_of_Legs;}
